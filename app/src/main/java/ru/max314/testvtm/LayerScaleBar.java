...
public class LayerScaleBar extends Layer implements Map.UpdateListener {
        ...
        public LayerScaleBar(MapView map) {
            super(map.map());
        ...
        private void setDefaultTexts() {
            mTextFields.put(TextField.FOOT, " фут");
            mTextFields.put(TextField.MILE, " мили");

            mTextFields.put(TextField.METER, " м");
            mTextFields.put(TextField.KILOMETER, " Км");
        }
